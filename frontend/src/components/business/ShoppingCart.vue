        ...
        <div class="content">
                ...
                <li class="order-box" v-for="item in list">
                    ...
                    <div class="order-info">
                        ...
                        <div class="order-info-item order-info-price">
                            EUR{{item.retailPriceEur}}/CNY{{item.retailPriceCny}}
                        </div>
                        <div class="order-info-item order-info-real-price">CNY {{item.finalPrice}}</div>

                        <div class="order-info-count-box">
                            <div class="order-info-count-item order-info-count-min "
                                 :class="{'order-info-count-grey':item.quantity==1}" @click="updateCount(item,-1)">-
                            </div>
                            <div class="order-info-count-item order-info-count">{{item.quantity}}</div>
                            <div class="order-info-count-item order-info-count-plus"
                                 :class="{'order-info-count-grey':item.quantity==item.repertory}"
            ...
            <div class="bottom-container">
                ...
                <div class="total-price">
                    ...
                    <label class="bottom-text3">CNY <label
                        class="selected-totalAmount">{{totalAmount.toFixed(2)}}</label></label>
                </div>
                <div class="btn-submit" @click="fillOrder" :class="{'btn-submit-enable': count>0}">下单<label
                    style="color: #ffffff;">({{count}})</label></div>
            </div>
        </div>
