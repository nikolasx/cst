<template>
  ...
  <div class="page page-current">
    ...
    <header class="bar bar-nav">
      ...
      <!--<a class="pull-right">
        <i class="iconfont icon-scan page-nav"></i>
      </a>-->
    </header>
      ...
      <ul class="form-container">
        <li class="form-item">
          ...
          <div class="item-input">
            <input v-bind:disabled="type=='edit'" v-model="form.proNo" class="field-input" placeholder="输入、扫一扫、必填"/>
          </div>
        </li>
        <li class="form-item">
        ...
        <li class="form-item">
          ...
          <div class="item-input">
            <select class="field-input" v-model="form.categoryId" placeholder="请选择品类" v-bind:disabled="type=='edit'">
        ...
        <li class="form-item">
          ...
          <div class="item-input">
            <select class="field-input" v-model="form.styleId" placeholder="请选择款式" v-bind:disabled="type=='edit'">
